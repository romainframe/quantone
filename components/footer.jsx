        ...
        <footer className="bg-[#8b5cf6] border-t-8 border-black">
            <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
                ...
                <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-6 mb-12">
                    <a href="/rhythms" className="px-8 py-4 bg-[#fbbf24] text-black font-black uppercase border-8 border-black hover:bg-[#f59e0b] transition-colors transform hover:scale-105">
                        RHYTHMS
                    </a>
